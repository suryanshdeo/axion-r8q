...
static int a96t3x6_wifi_recovery_mode_check(char *str)
{
...
EXPORT_SYMBOL(a96t3x6_wifi_recovery_mode_check);
__setup("androidboot.boot_recovery=", a96t3x6_wifi_recovery_mode_check);
